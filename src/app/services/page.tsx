...
<h1 className='md:text-2xl ml-3 md:ml-5 text-1xl  mt-5 mb-10 lg:ml-20 2xl:text-center'>Explore What we Offer</h1>


<div className='grid grid-cols-1 md:grid-cols-2 sm:ml-40 md:ml-16 lg:ml-36 2xl:ml-60
 xl:grid-cols-4 xl:grid-rows-2 md:gap-10 xl:ml-10 md:mr-10 ml-4 mr-4 gap-4 mb-10'>
{/* service 1  */}
<div className='w-72 h-72 2xl:w-96 2xl:h-96 2xl:px-10 2xl:text-xl pl-3 pr-3 border-2 bg-slate-100 animate__animated animate__slideInUp animate__delay-2s' id='serv'>
