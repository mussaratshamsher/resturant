...
{/* maingrid 2 */}
         <div className='ml-2 md:mr-5 md:border 2xl:border-none md:p-3 mb-2 md:mb-3 lg:mb-10 xl:mr-40'>

         <h1 className='text-2xl mt-5 mb-5 ml-2 md:hidden'> Send Your Message<hr className='w-60 border-gray-400 border'/></h1>

          <input type="text" placeholder='your name here' className='md:w-[150px] lg:w-[220px] xl:w-[248px] w-[300px] h-14 p-2 border border-red-300 rounded-md mr-2 mb-5'/> 
          <input type="text" placeholder='your email here' className='md:w-[150px] lg:w-[220px] xl:w-[246px] w-[300px] h-14  p-2 border border-red-300 rounded-md' /> <br />
